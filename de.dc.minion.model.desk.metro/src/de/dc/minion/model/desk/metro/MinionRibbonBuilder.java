...
public class MinionRibbonBuilder extends MinionSwitch<Object> {
	...
	private MinionRibbonControl minionDesk;
...
//		properties.initialize();
		return super.casePropertyVision(object);
	}
...
//		view.initialize();
		return super.caseRecentlyOpenVision(object);
	}
...
//		minionDesk.addMenuShowVision(object.getName(), (EmfViewPart) view);
	...
	public void setDesk(MinionRibbonControl minionDesk) {
		this.minionDesk = minionDesk;
		controlManager.registrate(MinionRibbonControl.ID, minionDesk);
	}
}
