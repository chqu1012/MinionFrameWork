...
/**
 * This is the item provider adapter for a {@link de.dc.minion.fx.model.Toady} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ToadyItemProvider extends ItemProviderAdapter
	 ...
	 * @generated
	 */
	public ToadyItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Toady_status_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Toady_status_feature", "_UI_Toady_type"),
						MinionPackage.Literals.TOADY__STATUS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MinionPackage.Literals.TOADY__TOUCH_POINTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Toady"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case MinionPackage.TOADY__STATUS:
			...
			return;
		case MinionPackage.TOADY__TOUCH_POINTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MinionPackage.Literals.TOADY__TOUCH_POINTS,
				MinionFactory.eINSTANCE.createToolbarTouch()));

		newChildDescriptors.add(createChildParameter(MinionPackage.Literals.TOADY__TOUCH_POINTS,
				MinionFactory.eINSTANCE.createCommandTouch()));

		newChildDescriptors.add(createChildParameter(MinionPackage.Literals.TOADY__TOUCH_POINTS,
				MinionFactory.eINSTANCE.createVisionTouch()));

		newChildDescriptors.add(createChildParameter(MinionPackage.Literals.TOADY__TOUCH_POINTS,
				MinionFactory.eINSTANCE.createDeskmanTouch()));

		newChildDescriptors.add(createChildParameter(MinionPackage.Literals.TOADY__TOUCH_POINTS,
				MinionFactory.eINSTANCE.createLandscapeTouch()));
	}
