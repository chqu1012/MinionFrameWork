...
/**
 * This is the item provider adapter for a {@link de.dc.minion.fx.model.Command} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommandItemProvider extends ItemProviderAdapter
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Command_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Command_id_feature", "_UI_Command_type"),
						MinionPackage.Literals.COMMAND__ID, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MinionPackage.Literals.COMMAND__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addHandlerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Command_handler_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Command_handler_feature",
								"_UI_Command_type"),
						MinionPackage.Literals.COMMAND__HANDLER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case MinionPackage.COMMAND__ID:
		case MinionPackage.COMMAND__NAME:
		case MinionPackage.COMMAND__HANDLER:
