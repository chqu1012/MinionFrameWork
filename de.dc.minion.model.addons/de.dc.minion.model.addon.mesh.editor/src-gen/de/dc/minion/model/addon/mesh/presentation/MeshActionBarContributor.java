...
/**
 * This is the action bar contributor for the Mesh model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MeshActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	 * Action to create objects from the Mesh model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			MeshModelWizard wizard = new MeshModelWizard();
	...
	protected IAction showPropertiesViewAction = new Action(
			MeshEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			MeshEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("mesh-settings"));
		toolBarManager.add(new Separator("mesh-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(MeshEditorPlugin.INSTANCE.getString("_UI_MeshEditor_menu"),
				"de.dc.minion.model.addon.meshMenuID");
		...
		//
		createChildMenuManager = new MenuManager(MeshEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(MeshEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(MeshEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(MeshEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
