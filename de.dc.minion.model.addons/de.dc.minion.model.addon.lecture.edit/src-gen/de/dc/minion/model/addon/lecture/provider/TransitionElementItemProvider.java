...
import de.dc.minion.model.addon.lecture.TransitionElement;

/**
 * This is the item provider adapter for a {@link de.dc.minion.model.addon.lecture.TransitionElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionElementItemProvider extends ItemProviderAdapter
	...
	public String getText(Object object) {
		Transition labelValue = ((TransitionElement) object).getTransition();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_TransitionElement_type")
				: getString("_UI_TransitionElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TransitionElement.class)) {
