...
/**
 * This is the item provider adapter for a {@link de.dc.minion.model.addon.mesh.Box} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BoxItemProvider extends RectangleItemProvider {
	/**
	...
	protected void addDepthPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Box_depth_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Box_depth_feature", "_UI_Box_type"),
						MeshPackage.Literals.BOX__DEPTH, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	protected void addPositionZPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Box_positionZ_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Box_positionZ_feature", "_UI_Box_type"),
						MeshPackage.Literals.BOX__POSITION_Z, true, false, false,
	...
	public String getText(Object object) {
		Double labelValue = ((Box) object).getPositionX();
