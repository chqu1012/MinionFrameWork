...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Inner Shadow Effect</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dc.minion.model.addon.snapshot.impl.InnerShadowEffectImpl#getBlurType <em>Blur Type</em>}</li>
 *   <li>{@link de.dc.minion.model.addon.snapshot.impl.InnerShadowEffectImpl#isChangeIsLocal <em>Change Is Local</em>}</li>
 *   <li>{@link de.dc.minion.model.addon.snapshot.impl.InnerShadowEffectImpl#getColor <em>Color</em>}</li>
 *   <li>{@link de.dc.minion.model.addon.snapshot.impl.InnerShadowEffectImpl#getChoke <em>Choke</em>}</li>
 *   <li>{@link de.dc.minion.model.addon.snapshot.impl.InnerShadowEffectImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link de.dc.minion.model.addon.snapshot.impl.InnerShadowEffectImpl#getOffsetX <em>Offset X</em>}</li>
 *   <li>{@link de.dc.minion.model.addon.snapshot.impl.InnerShadowEffectImpl#getOffsetY <em>Offset Y</em>}</li>
 *   <li>{@link de.dc.minion.model.addon.snapshot.impl.InnerShadowEffectImpl#getRadius <em>Radius</em>}</li>
 *   <li>{@link de.dc.minion.model.addon.snapshot.impl.InnerShadowEffectImpl#getSpread <em>Spread</em>}</li>
 *   <li>{@link de.dc.minion.model.addon.snapshot.impl.InnerShadowEffectImpl#getWidth <em>Width</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InnerShadowEffectImpl extends FXEffectImpl implements InnerShadowEffect {
	/**
	 ...
	 * @ordered
	 */
	protected static final double CHOKE_EDEFAULT = 0.0;
	 ...
	 * @ordered
	 */
	protected double choke = CHOKE_EDEFAULT;
	 ...
	 * @generated
	 */
	protected InnerShadowEffectImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SnapshotPackage.Literals.INNER_SHADOW_EFFECT;
	}
	...
	public void setBlurType(BlurType newBlurType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SnapshotPackage.INNER_SHADOW_EFFECT__BLUR_TYPE,
	...
	public void setChangeIsLocal(boolean newChangeIsLocal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SnapshotPackage.INNER_SHADOW_EFFECT__CHANGE_IS_LOCAL,
	...
	public void setColor(String newColor) {
		...
		color = newColor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SnapshotPackage.INNER_SHADOW_EFFECT__COLOR, oldColor,
					color));
	}
	 ...
	 */
	@Override
	public void setChoke(double newChoke) {
		double oldChoke = choke;
		choke = newChoke;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SnapshotPackage.INNER_SHADOW_EFFECT__CHOKE, oldChoke,
					choke));
	}
	...
	public void setHeight(double newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SnapshotPackage.INNER_SHADOW_EFFECT__HEIGHT,
					oldHeight, height));
	}
	...
	public void setOffsetX(double newOffsetX) {
		...
		offsetX = newOffsetX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SnapshotPackage.INNER_SHADOW_EFFECT__OFFSET_X,
					oldOffsetX, offsetX));
	}
	...
	public void setOffsetY(double newOffsetY) {
		...
		offsetY = newOffsetY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SnapshotPackage.INNER_SHADOW_EFFECT__OFFSET_Y,
					oldOffsetY, offsetY));
	}
	...
	public void setRadius(double newRadius) {
		...
		radius = newRadius;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SnapshotPackage.INNER_SHADOW_EFFECT__RADIUS,
					oldRadius, radius));
	}
	...
	public void setSpread(double newSpread) {
		...
		spread = newSpread;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SnapshotPackage.INNER_SHADOW_EFFECT__SPREAD,
					oldSpread, spread));
	}
	...
	public void setWidth(double newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SnapshotPackage.INNER_SHADOW_EFFECT__WIDTH, oldWidth,
					width));
	}
