...
import de.dc.javafx.xcore.workbench.chart.provider.ChartEditPlugin;
...
public class ChartModelWizard extends Wizard implements INewWizard {
	...
	public static final List<String> FILE_EXTENSIONS = Collections.unmodifiableList(Arrays
			.asList(ChartEditorPlugin.INSTANCE.getString("_UI_ChartEditorFilenameExtensions").split("\\s*,\\s*")));
	...
	public static final String FORMATTED_FILE_EXTENSIONS = ChartEditorPlugin.INSTANCE
			.getString("_UI_ChartEditorFilenameExtensions").replaceAll("\\s*,\\s*", ", ");
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setDefaultPageImageDescriptor(ExtendedImageRegistry.INSTANCE
				.getImageDescriptor(ChartEditorPlugin.INSTANCE.getImage("full/wizban/NewChart")));
	}
	...
	public boolean performFinish() {
		try {
			...
			if (new File(fileURI.toFileString()).exists()) {
				if (!MessageDialog.openQuestion(getShell(), ChartEditorPlugin.INSTANCE.getString("_UI_Question_title"),
						ChartEditorPlugin.INSTANCE.getString("_WARN_FileConflict",
		...
		public void createControl(Composite parent) {
			...
			resourceURIBrowseFileSystemButton.addSelectionListener(new SelectionAdapter() {
				...
				public void widgetSelected(SelectionEvent event) {
					String[] filters = ChartEditor.FILE_EXTENSION_FILTERS
							.toArray(new String[ChartEditor.FILE_EXTENSION_FILTERS.size()]);
		...
		protected Collection<String> getEncodings() {
			if (encodings == null) {
				...
				for (StringTokenizer stringTokenizer = new StringTokenizer(
						ChartEditorPlugin.INSTANCE.getString("_UI_XMLEncodingChoices")); stringTokenizer
								.hasMoreTokens();) {
	...
	public void addPages() {
		...
		initialObjectCreationPage
				.setDescription(ChartEditorPlugin.INSTANCE.getString("_UI_Wizard_initial_object_description"));
