...
import de.dc.javafx.xcore.workbench.chart.presentation.ChartEditorPlugin;
...
public final class ChartEditorAdvisor extends WorkbenchAdvisor {
	...
	private static String getString(String key, Object s1) {
		return de.dc.javafx.xcore.workbench.chart.presentation.ChartEditorPlugin.INSTANCE.getString(key,
				new Object[] { s1 });
	}
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "de.dc.javafx.xcore.workbench.chart.presentation.ChartEditorAdvisorPerspective";
