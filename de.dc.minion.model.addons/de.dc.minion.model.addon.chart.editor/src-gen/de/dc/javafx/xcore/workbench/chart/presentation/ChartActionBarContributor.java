...
public class ChartActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	...
	protected IAction showPropertiesViewAction = new Action(
			ChartEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			ChartEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public ChartActionBarContributor() {
		...
		liveValidationAction = new DiagnosticDecorator.LiveValidator.LiveValidationAction(
				ChartEditorPlugin.getPlugin().getDialogSettings());
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ChartEditorPlugin.INSTANCE.getString("_UI_ChartEditor_menu"),
				"de.dc.javafx.xcore.workbench.chartMenuID");
