 ...
 * </p>
 * <ul>
 *   <li>{@link de.dc.minion.model.addon.restaurant.reservation.impl.LayoutImpl#getItems <em>Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LayoutImpl extends MinimalEObjectImpl.Container implements Layout {
	 ...
	 * @ordered
	 */
	protected EList<LayoutItem> items;
	...
	protected EClass eStaticClass() {
		return ReservationPackage.Literals.LAYOUT;
	}
	 ...
	 */
	@Override
	public EList<LayoutItem> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<LayoutItem>(LayoutItem.class, this, ReservationPackage.LAYOUT__ITEMS);
		}
		return items;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ReservationPackage.LAYOUT__ITEMS:
			getItems().clear();
			getItems().addAll((Collection<? extends LayoutItem>) newValue);
			return;
		}
