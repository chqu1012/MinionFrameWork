 ...
 * @generated
 */
public class SnapshotActionBarContributor extends EditingDomainActionBarContributor
		implements ISelectionChangedListener {
	/**
	 * Action to create objects from the Snapshot model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			SnapshotModelWizard wizard = new SnapshotModelWizard();
	...
	protected IAction showPropertiesViewAction = new Action(
			SnapshotEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			SnapshotEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public SnapshotActionBarContributor() {
		...
		liveValidationAction = new DiagnosticDecorator.LiveValidator.LiveValidationAction(
				SnapshotEditorPlugin.getPlugin().getDialogSettings());
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				SnapshotEditorPlugin.INSTANCE.getString("_UI_SnapshotEditor_menu"),
				"de.dc.minion.model.addon.snapshotMenuID");
		...
		createSiblingMenuManager = new MenuManager(
				SnapshotEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
