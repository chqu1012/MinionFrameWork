...
public class XYChartFXItemProvider extends ChartFXItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ChartPackage.Literals.XY_CHART_FX__SERIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ChartPackage.Literals.XY_CHART_FX__SERIES,
				ChartFactory.eINSTANCE.createSeriesFX()));
	}
