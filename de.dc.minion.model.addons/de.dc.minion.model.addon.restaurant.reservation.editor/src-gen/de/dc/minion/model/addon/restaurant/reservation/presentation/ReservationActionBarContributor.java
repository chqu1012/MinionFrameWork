...
/**
 * This is the action bar contributor for the Reservation model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReservationActionBarContributor extends EditingDomainActionBarContributor
		implements ISelectionChangedListener {
	/**
	 * Action to create objects from the Reservation model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			ReservationModelWizard wizard = new ReservationModelWizard();
	...
	protected IAction showPropertiesViewAction = new Action(
			ReservationEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			ReservationEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("reservation-settings"));
		toolBarManager.add(new Separator("reservation-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				ReservationEditorPlugin.INSTANCE.getString("_UI_ReservationEditor_menu"),
				"de.dc.minion.model.addon.restaurant.reservationMenuID");
		...
		createChildMenuManager = new MenuManager(
				ReservationEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(
				ReservationEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(ReservationEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(ReservationEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
